...
PhoneticSuggestionV2::PhoneticSuggestionV2() {}

void PhoneticSuggestionV2::setLayout(QJsonObject lay) {
  parser.setLayout(lay);
}

QStringList PhoneticSuggestionV2::getDictionarySuggestion(QMap<QString, QString> splitWord) {
  QStringList words;
...
QMap<QString, QString> PhoneticSuggestionV2::getAutocorrect(QString word, QMap<QString, QString> splitWord) {
...
QMap<QString, QString> PhoneticSuggestionV2::separatePadding(QString word) {
...
QStringList PhoneticSuggestionV2::sortByPhoneticRelevance(QString phonetic, QStringList dictSuggestion) {
...
bool PhoneticSuggestionV2::isKar(QString word) {
  if (word.length() < 1) {
    return false;
  }
...
bool PhoneticSuggestionV2::isVowel(QString word) {
  if (word.length() < 1) {
    return false;
  }
...
void PhoneticSuggestionV2::appendIfNotContains(QStringList &array, QString item) {
  if (!array.contains(item)) {
    array.append(item);
  }
}

void PhoneticSuggestionV2::addToTempCache(QString full, QString base, QString eng) {
...
QStringList PhoneticSuggestionV2::addSuffix(QMap<QString, QString> splitWord) {
...
QString PhoneticSuggestionV2::getPrevSelected() {
  QString selected;
...
void PhoneticSuggestionV2::saveSelection(QString selected) {
...
QStringList PhoneticSuggestionV2::Suggest(QString word) {
